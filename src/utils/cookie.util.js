...
const __getCookieValue = (name) => {
  const data = __getCookie(name);
  return data.cookieExists ? jwt(data.cookieValue) : {};
};

export { __setCookie, __deleteCookie, __getCookie, __getCookieValue };
